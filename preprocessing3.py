...
mni_template = '/cvmfs/neurodesk.ardc.edu.au/containers/fsl_6.0.7.14_20241018/fsl_6.0.7.14_20241018.simg/opt/fsl-6.0.7.14/data/standard/MNI152_T1_1mm.nii.gz' #change to your fsl path
...
if not os.path.exists(anat_to_mni_output):
    ...
    flirt(bet_output_path, mni_template, out=anat_to_mni_output, omat=anat_to_mni_matrix)
else:
